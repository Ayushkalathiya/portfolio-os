...
import { PageTransition } from "@/components/system-ui/PageTransition";
            ...
            <footer className="border-t border-primary/10 bg-background/40 py-12 px-6">
                <div className="container mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
                    <div className="flex flex-col gap-2">
                        ...
                        <Link href="/consistency" className="font-mono text-[10px] text-slate-500 uppercase cursor-pointer">
